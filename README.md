...
web.php → Sistema de roteamento com validação e controle de acesso
🔐 Principais medidas implementadas:
Whitelist de rotas
Apenas rotas previamente definidas podem ser acessadas
Proteção contra Path Traversal
Uso de realpath() e validação de diretórios para impedir acesso indevido a arquivos
Normalização de URL
Evita bypass de rotas utilizando variações de caminhos
Security Headers
X-Frame-Options → Proteção contra Clickjacking
X-Content-Type-Options → Evita MIME sniffing
X-XSS-Protection → Proteção básica contra XSS
Content-Security-Policy (CSP) → Controle rigoroso de recursos carregados
Content Security Policy (CSP)
Restringe scripts, estilos e recursos externos, reduzindo significativamente o risco de XSS
...
Evoluir de projetos simples para arquiteturas mais robustas
...
Logging e monitoramento de eventos suspeitos
👨‍💻 Autor
